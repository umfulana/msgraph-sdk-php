...
namespace Microsoft\Graph\Generated\Groups\Item\MembersWithLicenseErrors\GraphApplication;

use Exception;
use Http\Promise\Promise;
use Http\Promise\RejectedPromise;
use Microsoft\Graph\Generated\Groups\Item\MembersWithLicenseErrors\GraphApplication\Count\CountRequestBuilder;
...
class GraphApplicationRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/groups/{group%2Did}/membersWithLicenseErrors/graph.application{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}');
