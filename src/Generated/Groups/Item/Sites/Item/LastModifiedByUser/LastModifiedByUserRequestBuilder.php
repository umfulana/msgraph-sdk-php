...
namespace Microsoft\Graph\Generated\Groups\Item\Sites\Item\LastModifiedByUser;

use Exception;
use Http\Promise\Promise;
use Http\Promise\RejectedPromise;
use Microsoft\Graph\Generated\Groups\Item\Sites\Item\LastModifiedByUser\MailboxSettings\MailboxSettingsRequestBuilder;
use Microsoft\Graph\Generated\Groups\Item\Sites\Item\LastModifiedByUser\ServiceProvisioningErrors\ServiceProvisioningErrorsRequestBuilder;
...
class LastModifiedByUserRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/lastModifiedByUser{?%24select,%24expand}');
