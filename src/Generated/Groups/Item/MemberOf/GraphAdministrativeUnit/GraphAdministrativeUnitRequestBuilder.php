...
namespace Microsoft\Graph\Generated\Groups\Item\MemberOf\GraphAdministrativeUnit;

use Exception;
use Http\Promise\Promise;
use Http\Promise\RejectedPromise;
use Microsoft\Graph\Generated\Groups\Item\MemberOf\GraphAdministrativeUnit\Count\CountRequestBuilder;
...
class GraphAdministrativeUnitRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/groups/{group%2Did}/memberOf/graph.administrativeUnit{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}');
