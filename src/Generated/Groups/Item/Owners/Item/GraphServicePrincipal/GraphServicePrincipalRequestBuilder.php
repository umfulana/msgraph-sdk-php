...
namespace Microsoft\Graph\Generated\Groups\Item\Owners\Item\GraphServicePrincipal;
...
class GraphServicePrincipalRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/groups/{group%2Did}/owners/{directoryObject%2Did}/graph.servicePrincipal{?%24select,%24expand}');
