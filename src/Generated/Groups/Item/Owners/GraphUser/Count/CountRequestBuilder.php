...
namespace Microsoft\Graph\Generated\Groups\Item\Owners\GraphUser\Count;
...
class CountRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/groups/{group%2Did}/owners/graph.user/$count{?%24search,%24filter}');
