...
namespace Microsoft\Graph\Generated\Devices\Item\RegisteredOwners\Item\GraphUser;
...
class GraphUserRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/devices/{device%2Did}/registeredOwners/{directoryObject%2Did}/graph.user{?%24select,%24expand}');
