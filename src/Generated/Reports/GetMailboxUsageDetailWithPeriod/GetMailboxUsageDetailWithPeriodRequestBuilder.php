...
*/
class GetMailboxUsageDetailWithPeriodRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $period = null) {
        parent::__construct($requestAdapter, [], '{+baseurl}/reports/getMailboxUsageDetail(period=\'{period}\')');
    ...
    */
    public function withUrl(string $rawUrl): GetMailboxUsageDetailWithPeriodRequestBuilder {
