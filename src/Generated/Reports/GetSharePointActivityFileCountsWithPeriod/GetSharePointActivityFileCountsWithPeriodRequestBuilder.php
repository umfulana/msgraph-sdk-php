...
*/
class GetSharePointActivityFileCountsWithPeriodRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $period = null) {
        parent::__construct($requestAdapter, [], '{+baseurl}/reports/getSharePointActivityFileCounts(period=\'{period}\')');
    ...
    */
    public function withUrl(string $rawUrl): GetSharePointActivityFileCountsWithPeriodRequestBuilder {
