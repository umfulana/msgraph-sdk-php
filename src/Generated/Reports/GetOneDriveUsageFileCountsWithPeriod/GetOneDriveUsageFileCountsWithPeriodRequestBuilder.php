...
namespace Microsoft\Graph\Generated\Reports\GetOneDriveUsageFileCountsWithPeriod;
...
*/
class GetOneDriveUsageFileCountsWithPeriodRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $period = null) {
        parent::__construct($requestAdapter, [], '{+baseurl}/reports/getOneDriveUsageFileCounts(period=\'{period}\')');
