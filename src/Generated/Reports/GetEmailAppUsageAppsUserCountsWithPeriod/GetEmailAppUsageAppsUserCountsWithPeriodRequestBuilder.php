...
*/
class GetEmailAppUsageAppsUserCountsWithPeriodRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $period = null) {
        parent::__construct($requestAdapter, [], '{+baseurl}/reports/getEmailAppUsageAppsUserCounts(period=\'{period}\')');
    ...
    */
    public function toGetRequestInformation(?GetEmailAppUsageAppsUserCountsWithPeriodRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
    ...
    */
    public function withUrl(string $rawUrl): GetEmailAppUsageAppsUserCountsWithPeriodRequestBuilder {
