...
namespace Microsoft\Graph\Generated\Reports\GetSharePointSiteUsageFileCountsWithPeriod;
...
*/
class GetSharePointSiteUsageFileCountsWithPeriodRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $period = null) {
        parent::__construct($requestAdapter, [], '{+baseurl}/reports/getSharePointSiteUsageFileCounts(period=\'{period}\')');
    ...
    */
    public function withUrl(string $rawUrl): GetSharePointSiteUsageFileCountsWithPeriodRequestBuilder {
        return new GetSharePointSiteUsageFileCountsWithPeriodRequestBuilder($rawUrl, $this->requestAdapter);
    }
