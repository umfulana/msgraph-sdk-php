...
*/
class GetMailboxUsageMailboxCountsWithPeriodRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $period = null) {
        parent::__construct($requestAdapter, [], '{+baseurl}/reports/getMailboxUsageMailboxCounts(period=\'{period}\')');
    ...
    */
    public function withUrl(string $rawUrl): GetMailboxUsageMailboxCountsWithPeriodRequestBuilder {
