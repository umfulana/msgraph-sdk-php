...
namespace Microsoft\Graph\Generated\Reports\GetSharePointSiteUsageStorageWithPeriod;
...
*/
class GetSharePointSiteUsageStorageWithPeriodRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $period = null) {
        parent::__construct($requestAdapter, [], '{+baseurl}/reports/getSharePointSiteUsageStorage(period=\'{period}\')');
    ...
    */
    public function withUrl(string $rawUrl): GetSharePointSiteUsageStorageWithPeriodRequestBuilder {
