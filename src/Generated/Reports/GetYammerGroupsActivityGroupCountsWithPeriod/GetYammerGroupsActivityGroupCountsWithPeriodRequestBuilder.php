...
namespace Microsoft\Graph\Generated\Reports\GetYammerGroupsActivityGroupCountsWithPeriod;
...
*/
class GetYammerGroupsActivityGroupCountsWithPeriodRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter, ?string $period = null) {
        parent::__construct($requestAdapter, [], '{+baseurl}/reports/getYammerGroupsActivityGroupCounts(period=\'{period}\')');
    ...
    */
    public function withUrl(string $rawUrl): GetYammerGroupsActivityGroupCountsWithPeriodRequestBuilder {
        return new GetYammerGroupsActivityGroupCountsWithPeriodRequestBuilder($rawUrl, $this->requestAdapter);
    }
