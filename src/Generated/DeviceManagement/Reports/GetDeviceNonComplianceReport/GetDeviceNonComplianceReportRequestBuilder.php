...
*/
class GetDeviceNonComplianceReportRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceManagement/reports/getDeviceNonComplianceReport');
    ...
    */
    public function toPostRequestInformation(GetDeviceNonComplianceReportPostRequestBody $body, ?GetDeviceNonComplianceReportRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
    ...
    */
    public function withUrl(string $rawUrl): GetDeviceNonComplianceReportRequestBuilder {
