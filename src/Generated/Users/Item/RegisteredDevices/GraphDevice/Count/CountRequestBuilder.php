...
namespace Microsoft\Graph\Generated\Users\Item\RegisteredDevices\GraphDevice\Count;
...
class CountRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/users/{user%2Did}/registeredDevices/graph.device/$count{?%24search,%24filter}');
