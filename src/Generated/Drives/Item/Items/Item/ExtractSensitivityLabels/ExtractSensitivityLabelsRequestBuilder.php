...
namespace Microsoft\Graph\Generated\Drives\Item\Items\Item\ExtractSensitivityLabels;
...
class ExtractSensitivityLabelsRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/extractSensitivityLabels');
