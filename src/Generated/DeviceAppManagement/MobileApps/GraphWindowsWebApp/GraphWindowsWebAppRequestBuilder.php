...
namespace Microsoft\Graph\Generated\DeviceAppManagement\MobileApps\GraphWindowsWebApp;

use Exception;
use Http\Promise\Promise;
use Http\Promise\RejectedPromise;
use Microsoft\Graph\Generated\DeviceAppManagement\MobileApps\GraphWindowsWebApp\Count\CountRequestBuilder;
use Microsoft\Graph\Generated\Models\ODataErrors\ODataError;
use Microsoft\Graph\Generated\Models\WindowsWebAppCollectionResponse;
...
class GraphWindowsWebAppRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceAppManagement/mobileApps/graph.windowsWebApp{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}');
     ...
     * @return Promise<WindowsWebAppCollectionResponse|null>
    */
    public function get(?GraphWindowsWebAppRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
        ...
        try {
            ...
            return $this->requestAdapter->sendAsync($requestInfo, [WindowsWebAppCollectionResponse::class, 'createFromDiscriminatorValue'], $errorMappings);
        } catch(Exception $ex) {
