...
class AssignRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/assign');
     ...
     * @link https://learn.microsoft.com/graph/api/intune-apps-mobileapp-assign?view=graph-rest-1.0 Find more info here
    */
