...
namespace Microsoft\Graph\Generated\Security\ThreatIntelligence\Subdomains\Item;
...
use Microsoft\Graph\Generated\Security\ThreatIntelligence\Subdomains\Item\Host\HostRequestBuilder;
...
class SubdomainItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/security/threatIntelligence/subdomains/{subdomain%2Did}{?%24select,%24expand}');
     ...
     * @param SubdomainItemRequestBuilderDeleteRequestConfiguration|null $requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @return Promise<void|null>
    */
    public function delete(?SubdomainItemRequestBuilderDeleteRequestConfiguration $requestConfiguration = null): Promise {
    ...
    */
     ...
     * @param SubdomainItemRequestBuilderPatchRequestConfiguration|null $requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @return Promise<Subdomain|null>
    */
    public function patch(Subdomain $body, ?SubdomainItemRequestBuilderPatchRequestConfiguration $requestConfiguration = null): Promise {
    ...
    */
    public function toDeleteRequestInformation(?SubdomainItemRequestBuilderDeleteRequestConfiguration $requestConfiguration = null): RequestInformation {
    ...
    */
     ...
     * @return RequestInformation
    */
    public function toPatchRequestInformation(Subdomain $body, ?SubdomainItemRequestBuilderPatchRequestConfiguration $requestConfiguration = null): RequestInformation {
        $requestInfo = new RequestInformation();
        $requestInfo->urlTemplate = $this->urlTemplate;
        $requestInfo->pathParameters = $this->pathParameters;
